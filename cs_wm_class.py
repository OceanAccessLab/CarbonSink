...
if TSDIC:
    fig_name = 'T-S-DIC_carbon_wm_' + class_type + '.png'
else:
    fig_name = 'T-S_carbon_wm_' + class_type + '.png'
...
# 2023 version:
if TSDIC:
    df = pd.read_csv('./Testing_classification/NLonly_data_CT_SA_DIC_classes.csv', delimiter=',')
else:
    df = pd.read_csv('./Testing_classification/NLonly_data_CT_SA_classes.csv', delimiter=',')
# 2021 version:
