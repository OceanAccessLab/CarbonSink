...
if TSDIC:
     file_name = './Testing_classification/all_data_CT_SA_DIC_classes.csv'
     fig_name = 'azmp_map_carbon_wm_' + class_type + '_' + str(zlims[0]) + '-' + str(zlims[1]) + 'm.png'
else:
     file_name = './Testing_classification/all_data_CT_SA_classes.csv'
     fig_name = 'azmp_map_carbon_wmTS_' + class_type + '_' + str(zlims[0]) + '-' + str(zlims[1]) + 'm.png'
